...
@Component({
  ...
  template: `
    <nav class="fixed top-0 left-0 bottom-0 w-[280px] bg-white/90 backdrop-blur-xl flex flex-col px-8 pt-[120px] pb-8 overflow-y-auto z-100 custom-scrollbar border-r border-border-timeline shadow-[20px_0_40px_rgba(0,0,0,0.05)] transform transition-transform duration-300"
         tabindex="-1"
