import { Component, ChangeDetectionStrategy, ElementRef, ViewChild, inject, signal, effect, ChangeDetectorRef, computed } from '@angular/core';
...
export class AddAssetModalComponent {
  ...
  confirmCreate() {
     if (this.store.addModalType().startsWith('flow')) {
         ...
         const finalType = this.flowCategory === 'other' ? (this.customFlowCategory || 'general') : this.flowCategory;
